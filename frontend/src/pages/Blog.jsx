            ...
            <main className="pt-28 pb-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="page-title !text-4xl font-display">Latest <span className="bg-gradient-to-r from-violet-600 to-fuchsia-500 dark:from-violet-400 dark:to-fuchsia-300 bg-clip-text text-transparent">updates</span></h2>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                        {posts.map((post, i) => (
                            <article key={i} className="card card-hover overflow-hidden group bg-white dark:bg-space-800">
